...
{/* 			<MyButton fcn={props.fcn1} buttonLabel={props.buttonLabel1} /><MyButton fcn={props.fcn1} buttonLabel={props.buttonLabel1} /> */} 
		<button onClick={props.fcn1} className="cta-button">{props.buttonLabel1}</button> NEXT <button onClick={props.fcn2} className="cta-button">{props.buttonLabel2}</button>  
		</div>
	);
